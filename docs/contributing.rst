...
.. note::
  ...
  As a general rule of thumb, **SPSS Converter** applies :pep:`PEP 8 <8>` styling,
...
**SPSS Converter** is meant to be a "beautiful" and "usable" library. That means
...
**SPSS Converter** we rely on several tools:
...
#. Fork the `Git repository <https://github.com/insightindustry/spss-converter>`_.
...
Check for open `issues <https://github.com/insightindustry/spss-converter/issues>`_
...
.. seealso::
  ...
  For more information about the **SPSS Converter** testing approach please
  see: :doc:`Testing SPSS Converter <testing>`
