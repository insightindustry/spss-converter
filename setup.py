spss-converterspss-converter"""A setuptools based setup module.
...
version_dict = {}
with open(path.join(here, 'spss_converter', '__version__.py')) as version_file:
...
setup(
    ...
    description=('Simple format converter utility for SPSS data files'),  # Required
    ...
    url='https://spss-converter.readthedocs.io/en/latest',  # Optional
    ...
    keywords='spss data conversion serialization CSV JSON YAML dict dataframe pandas deserialization',  # Optional
    ...
    #    ('spss-converter', ['README.rst']),
    #    ('spss-converter', ['VERSION']),
    #],
